        ...
        <div className='w-full flex items-center gap-3'>
            <div className={`w-full items-center gap-3 p-4 flex relative`}>
                ...
                <div className='flex items-start flex-col'>
                    ...
                    <p className='text-textColor'>{allSongs[songIndex]?.artist}{""}
...
export const PlayListCard = () => {
    ...
    return <div className='absolute left-4 bottom-24 gap-2 py-2 w-350 max-w-[350px] h-510 max-h-[410px] flex flex-col overflow-y-scroll scrollbar-thin rounded-md shadow-md bg-primary z-30'>
        {allSongs.length > 0 ? (
            allSongs.map((music, index) => (
                <motion.div
                    ...
                    className='group w-full p-4 hover:bg-card flex gap-3 items-center cursor-pointer bg-transparent' onClick={() => setCurrentPlaySong(index)}
                    key={index}>
